...
public class MatchView {
		...
		JButton backButtonMatchView = new JButton("Volver");
		...
		public MatchView() {
			...
			//BackButton
			backButtonMatchView.setBounds(20, 420, 85, 30);
			mainFrameMatchView.add(backButtonMatchView);
		...
		public JButton getBackButtonMatchView() {
			return this.backButtonMatchView;
		}
